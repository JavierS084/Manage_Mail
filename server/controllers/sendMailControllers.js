      ...
      html: `<!DOCTYPE html>
        ...
        <div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
          <div style="margin:50px auto;width:90%;padding:20px 0">
            ...
            <p>Gracias por elegir CodeArk35. Utilice el siguiente enlace: http://localhost:5173/reset-password/${uuid} para completar su procedimiento de recuperación de contraseña.</p>
